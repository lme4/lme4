...
## right now this is what checkRankZ does (without the 'tol' optional argument)
rfun <- function(Zt, tol)
    rankMatrix(if(doTr) t(Zt) else Zt, method = "qr",
               sval = numeric(min(d)), tol=tol)
