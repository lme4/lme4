...
test_that("glmerForm", {
    ...
    ## formulas have environments associated, but strings don't???
    ## data argument not specified:
    ## technically **should** work but documentation warns against it
    ...
    m_data_List <- list(m_data.0,m_data.1,m_data.2,m_data.3,m_data.4)
