...
Some of this overlaps with questions about the design of the `flexLambda` [branch](https://github.com/lme4/lme4/tree/flexLambda/) of `lme4`, and with Steve's `lme4ord` [package](http://stevencarlislewalker.github.io/lme4ord/).
...
Some `lme4ord` [examples](http://stevencarlislewalker.github.io/lme4ord/analysts.html) illustrate the basic idea of `lme4ord`, but these aren't full runable examples.  Here is a simple one that is runable:
```{r lme4ord}
## require(lme4ord)
## FIXME
```
