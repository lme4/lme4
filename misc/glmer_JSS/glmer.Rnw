...
<<cm1,echo=FALSE,message=FALSE,size='scriptsize'>>=
...
cm5 <- glmer(use ~ age*ch + I(age^2) + urban + (1|urban:district) + (1|district), control = glmerControl(autoscale=TRUE),
                           Contraception, binomial)
@
...
load(file="glmer_profbatch2.RData")
@
