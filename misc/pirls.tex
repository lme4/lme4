...
corresponding conditional mean of $\mc Y|\mc U=\bm u^{(i)}$,
and $\bm P$ denotes a fill-reducing permutation that is computed based on the sparsity pattern
