...
load(system.file("vignette_data", "lmer_batch.rda", package = "lme4"))
@
...
\end{itemize}
<<profile_calc,echo=FALSE>>=
## used to compute pf here, but was computed above, in the confidence interval chunk (compareCI)
@
