...
Published in the (online) \emph{Journal of Statistical Software},
on Oct.\ 2015, with DOI \texttt{10.18637/jss.v067.i01},
...
%% The  JSS(2015) paper has here a paragraph about \pkg{nlme}
