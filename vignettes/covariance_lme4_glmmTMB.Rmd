...
vignette: >
  %\VignetteIndexEntry{Covariance Structures lme4 vs glmmTMB}
...
lme4.rho <- sqrt(lme4:::getVC(lme4:::getReCovs(lme4.cs)[[1]])$ccomp)
glmmTMB.rho <- sqrt(attr(summary(glmmTMB.cs)$varcor$cond$group, "correlation")[1, 2])
...
## Comparing against the predicted rho value
lme4.ar1.rho <- lme4:::getVC(lme4:::getReCovs(lme4.ar1)[[1]])$ccomp
glmmTMB.ar1.rho <- attr(summary(glmmTMB.ar1)$varcor$cond$group, "correlation")[1, 2]
