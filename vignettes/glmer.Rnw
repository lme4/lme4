...
covariance matrix for the spherized random effects, conditional on the  % I tend to refer to them as the "spherical" random effects but I can live with this.  DMB
